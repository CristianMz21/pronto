        ...
        <div className="space-y-8 text-gray-700 leading-relaxed">
          <section>
            ...
            <p>
              ...
              <span className="font-medium">trypronto.app</span> (&ldquo;Service&rdquo;), how we use
              it, and your rights regarding that data. This policy is compliant with the General
          ...
          <section>
            ...
            <p className="mb-3">
              If you are located in the European Economic Area (EEA), our legal basis for collecting
              and using personal data is:
            </p>
            <ul className="list-disc pl-6 space-y-1.5">
              <li>
          ...
          <section>
            ...
            <p>
              ...
              provide the Service. If you delete your account, we will delete or anonymize your data
          ...
          <section>
            ...
            <p>
              ...
              reviews. However, no method of transmission over the internet is completely secure.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1.5">
              <li>
                <span className="font-medium">Access</span> — request a copy of the personal data we
                hold about you.
              </li>
              <li>
              ...
              <li>
                <span className="font-medium">Erasure</span> — request deletion of your personal
                data (&ldquo;right to be forgotten&rdquo;).
              </li>
              <li>
                <span className="font-medium">Restriction</span> — request that we limit how we use
                your data.
              </li>
              <li>
          ...
          <section>
            ...
            <p>
              ...
              tracking or advertising cookies. You can configure your browser to refuse cookies, but
              this may prevent you from logging in to the Service.
            </p>
          </section>
          ...
          <section>
            ...
            <p>For privacy-related questions or to exercise your rights, please contact us at:</p>
