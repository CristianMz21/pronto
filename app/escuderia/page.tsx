...
export const metadata: Metadata = {
  ...
  description:
    'Escudería Barbería en Colombia. Corte Clásico $30.000, Corte + Barba $45.000. Lun-Sáb 09:00-20:00. Reserva online sin registro. +57 300 123 4567',
  alternates: {
    canonical: '/escuderia',
  },
  openGraph: {
...
export default async function EscuderiaLandingPremium() {
  ...
  const { data: business } = await supabase
    .from('businesses')
    .select('id, name, slug, phone, address, timezone, currency, brand_color')
    .eq('slug', 'escuderia')
    .maybeSingle()
  ...
  return (
    <div
      className={`${playfair.variable} ${montserrat.variable} min-h-screen bg-[#0A0A0A] text-[#e5e2e1] selection:bg-[#C5A059] selection:text-black antialiased max-w-full overflow-hidden`}
    >
      <script
      ...
      <nav className="fixed top-0 w-full z-50 bg-[#0A0A0A]/40 backdrop-blur-xl border-b border-[#8E795E]/20">
        <div className="flex justify-between items-center px-5 md:px-16 h-20 w-full mx-auto max-w-[1280px]">
          <Link
            href="/escuderia"
            className="font-[var(--font-playfair)] text-[22px] font-bold tracking-tight text-[#C5A059] flex items-center gap-3"
          >
          ...
          <ul className="hidden md:flex gap-8 items-center">
            <li>
              <a
                className="font-[var(--font-montserrat)] text-[12px] tracking-[0.2em] font-semibold text-[#d0c5b9] hover:text-[#C5A059] nav-link"
                href="#experience"
              >
                EXPERIENCIA
              </a>
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="hidden md:flex items-center gap-1.5 text-sm text-[#d0c5b9] hover:text-[#C5A059]"
            >
              {bizPhone}
            </a>
            <Link
              href="/book/escuderia"
              className="hidden md:inline-flex border border-[#C5A059] text-[#C5A059] px-6 py-2.5 font-[var(--font-montserrat)] text-[14px] tracking-[0.15em] font-medium hover:bg-[#C5A059] hover:text-black transition-colors"
            >
              RESERVAR
            </Link>
            <Link
              href={accountHref}
              className="md:hidden font-[var(--font-montserrat)] text-[11px] tracking-[0.15em] font-medium text-[#d0c5b9] hover:text-[#C5A059]"
            >
              MI CUENTA
            </Link>
            <Link
              href="/book/escuderia"
              className="md:hidden border border-[#C5A059] text-[#C5A059] px-4 py-2 font-[var(--font-montserrat)] text-[11px] tracking-[0.15em] font-medium"
            >
              RESERVAR
            </Link>
          </div>
      ...
      <main className="pt-20">
        ...
        <section className="relative h-[80vh] md:h-screen w-full flex flex-col justify-end md:items-center md:justify-center overflow-hidden pb-12 md:pb-0">
          <div className="absolute inset-0">
            <div
              ...
              style={{ backgroundImage: "url('/escuderia/hero.jpg')" }}
            />
          ...
          <div className="relative z-10 w-full max-w-[1280px] mx-auto px-5 md:px-16">
            <div className="md:hidden w-full max-w-[350px]">
              ...
              <div className="mt-8 flex flex-col gap-3">
                <Link
                  href="/book/escuderia"
                  className="btn-gold border border-[#C5A059] text-[#C5A059] w-full py-4 font-[var(--font-montserrat)] text-[14px] tracking-[0.15em] font-medium inline-flex items-center justify-center gap-2 bg-transparent"
                >
            ...
            <div className="hidden md:flex flex-col items-center text-center mx-auto">
              ...
              <div className="mt-10 flex flex-col items-center gap-3">
                <Link
                  href="/book/escuderia"
                  className="btn-gold border border-[#C5A059] text-[#C5A059] px-10 py-4 font-[var(--font-montserrat)] text-[14px] tracking-[0.15em] font-medium inline-flex items-center gap-3 bg-transparent"
                >
                  RESERVAR CITA <span>→</span>
                </Link>
                <Link
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
            <div className="md:col-span-5">
              <span className="font-[var(--font-montserrat)] text-[12px] tracking-[0.2em] font-semibold text-[#C5A059] block mb-4">
                EL ENTORNO
              </span>
              ...
              <p className="font-[var(--font-montserrat)] text-[16px] leading-6 text-[#d0c5b9] mt-6">
                ...
                envejecido, acero oscuro y maderas nobles— con absoluta privacidad. Un ritual donde
            ...
            <div className="md:col-span-7 grid grid-cols-2 gap-4 h-[420px] md:h-[600px]">
              <div className="pt-8 md:pt-12 h-full">
                <img
                  alt="Cuero barbería — textura cuero envejecido Escudería"
                  className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-700 border border-[#8E795E]/20"
                  src="/escuderia/cuero.png"
                  loading="lazy"
                  decoding="async"
                />
              </div>
              <div className="pb-8 md:pb-12 h-full">
                <img
                  alt="Tijeras acero profesional Escudería — detalle tijeras japonesas"
                  className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-700 border border-[#8E795E]/20"
                  src="/escuderia/tijeras.png"
                  loading="lazy"
                  decoding="async"
                />
              </div>
        ...
        <section
          id="services"
          className="py-[80px] md:py-[120px] px-5 md:px-16 bg-[#0e0e0e] border-y border-[#8E795E]/10"
        >
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="font-[var(--font-montserrat)] text-[14px] text-[#d0c5b9] mt-3">
                Precios en COP • America/Bogota
              </p>
            </div>
            <div className="flex flex-col">
              {svc.length === 0 ? (
                <p className="font-[var(--font-montserrat)] text-sm text-[#d0c5b9] text-center py-8">
                  Pronto: servicios Escudería
                </p>
              ) : (
                svc.map((s) => (
                  <Link
                    key={s.id}
                    href={`/book/escuderia?service=${s.id}`}
                    className="gold-dashed py-6 flex justify-between items-baseline group hover:pl-2 transition-all"
                  >
                    <div className="pr-8">
                      <h3 className="font-[var(--font-montserrat)] text-[14px] tracking-[0.15em] font-medium text-white group-hover:text-[#C5A059] transition-colors">
                        {s.name.toUpperCase()}
                      </h3>
            ...
            <div className="mt-10 text-center">
              <Link
                href="/book/escuderia"
                className="btn-gold border border-[#C5A059] text-[#C5A059] px-8 py-3 font-[var(--font-montserrat)] text-[14px] tracking-[0.15em] font-medium inline-block"
              >
                RESERVAR AHORA
              </Link>
            </div>
        ...
        >
          <div className="text-center mb-10">
            <span className="font-[var(--font-montserrat)] text-[12px] tracking-[0.2em] font-semibold text-[#C5A059]">
              EL EQUIPO
            </span>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {emps.map((e) => (
              <div
                key={e.id}
                className="border border-[#8E795E]/20 p-6 text-center bg-[#121212] hover:bg-[#201f1f] transition-colors"
              >
                <div
                  className="w-16 h-16 mx-auto flex items-center justify-center text-white font-bold border border-[#C5A059]/30"
                  style={{ background: (e.color as string) || '#1a1a1a' }}
                >
                  {e.name
                    .split(' ')
                    .map((w) => w[0])
        ...
        <section
          id="area-cliente"
          className="py-[80px] md:py-[120px] px-5 md:px-16 max-w-[1280px] mx-auto border-y border-[#8E795E]/10 bg-[#0e0e0e]"
        >
          <div className="text-center mb-12">
            <span className="font-[var(--font-montserrat)] text-[12px] tracking-[0.2em] font-semibold text-[#C5A059] block mb-4">
              ÁREA CLIENTE
          ...
          <div className="mt-12 flex flex-col md:flex-row items-center justify-center gap-4">
            <Link
              href="/client/login"
              className="btn-gold border border-[#C5A059] text-[#C5A059] px-8 py-3.5 font-[var(--font-montserrat)] text-[14px] tracking-[0.15em] font-medium inline-flex items-center justify-center w-full md:w-auto bg-transparent"
            >
          ...
          <p className="font-[var(--font-montserrat)] text-[12px] tracking-[0.05em] text-[#8E795E] text-center mt-6">
            El flujo público en{' '}
            <Link href="/book/escuderia" className="text-[#C5A059] hover:underline">
              /book/escuderia
            </Link>{' '}
        ...
        <section className="py-[80px] md:py-[120px] relative overflow-hidden">
          <div className="absolute inset-0">
            <div
              ...
              style={{ backgroundImage: "url('/escuderia/signature.jpg')" }}
            />
          ...
          <div className="relative z-10 max-w-[1280px] mx-auto px-5 md:px-16 text-center">
            <div className="inline-block border border-[#C5A059]/30 px-6 py-2 mb-8">
              <span className="font-[var(--font-montserrat)] text-[12px] tracking-[0.3em] font-semibold text-[#C5A059]">
            ...
            <Link
              href="/book/escuderia"
              className="btn-gold mt-10 border border-[#C5A059] text-[#C5A059] px-8 py-3 font-[var(--font-montserrat)] text-[14px] tracking-[0.15em] font-medium inline-block bg-[#121212]"
            >
        ...
        >
          {[
            {
              k: 'Horario',
              v: `${horario} • ${diasAbiertos}`,
              sub: 'Domingo cerrado • America/Bogota',
            },
            ...
            <div key={c.k} className="border border-[#8E795E]/20 p-6 bg-[#121212]">
              <div className="font-[var(--font-montserrat)] text-[11px] tracking-[0.2em] font-semibold text-[#C5A059]">
                {c.k.toUpperCase()}
              </div>
      ...
      <footer className="w-full py-12 bg-[#0e0e0e] border-t border-[#8E795E]/10">
        <div className="flex flex-col md:flex-row justify-between items-center px-5 md:px-16 gap-8 w-full max-w-[1280px] mx-auto">
          <div className="font-[var(--font-playfair)] text-xl font-bold text-[#C5A059]">
            {bizName.toUpperCase()}
          </div>
          <div className="flex gap-8 font-[var(--font-montserrat)] text-[12px] tracking-[0.2em] font-semibold text-[#d0c5b9]">
            <Link href="/book/escuderia" className="hover:text-[#C5A059]">
              RESERVAR
            </Link>
            <Link href="/client/login" className="hover:text-[#C5A059]">
              MI CUENTA
            </Link>
            <a
          ...
          <div className="font-[var(--font-montserrat)] text-[11px] tracking-[0.15em] text-[#8E795E]">
            © 2026 {bizName.toUpperCase()} • {bizAddress.toUpperCase()} • {currency}
          </div>
        </div>
      </footer>
    </div>
