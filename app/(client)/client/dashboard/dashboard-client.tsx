...
export function DashboardClient({
  ...
  function getServiceName(row: { services?: unknown }): string {
    const s = (row as { services: unknown }).services as
      | { name: string }
      | { name: string }[]
      | null
    if (!s) return ''
          ...
          <div className="border border-blue-200 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-5">
            <div className="flex items-start justify-between gap-4">
              <div className="min-w-0">
                ...
                <div className="inline-flex items-center gap-2 text-xs mt-2">
                  ...
                  {upcoming.price ? (
                    <span className="text-gray-600">· ${upcoming.price}</span>
                  ) : null}
                </div>
              </div>
              <a
                ...
                className="hidden sm:inline-flex items-center gap-1.5 text-sm font-medium text-blue-700 bg-white border border-blue-200 rounded-lg px-3 py-2 hover:bg-blue-50 shrink-0"
              >
                Ver cita
              </a>
            </div>
            <div className="flex flex-wrap gap-2 mt-4">
              ...
              <a
                ...
                className="sm:hidden flex-1 text-center text-sm px-4 py-2 rounded-lg bg-white border border-blue-200 text-blue-700 font-medium"
              >
                Ver cita
              </a>
            </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Link
                      href={rebookHref}
                      className="text-xs px-2 py-1 rounded-md bg-gray-900 text-white hover:bg-black"
                    >
                      Rebook
                    </Link>
                    {(h.status === 'pending' ||
