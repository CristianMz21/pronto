...
const copy: Record<EmptyVariant, { title: string; description: string }> = {
  memberships: {
    ...
    description: 'Crea tu primer plan — ej. “4 cortes/mes $99k”. Los clientes verán sus usos restantes al reservar.',
  },
  promotions: {
    title: 'Sin promociones activas',
    description: 'Configura un descuento por segmento, día o servicio y pruébalo antes de publicar.',
  },
  locations: {
    title: 'Sin sucursales adicionales',
    description: 'La sede por defecto “Escudería Centro” ya está creada. Agrega Norte, Sur u otras sedes aquí.',
  },
  campaigns: {
    title: 'Sin campañas aún',
    description: 'Elige un segmento (p. ej. inactivos 42 días) y lanza tu primera campaña de WhatsApp en 30 s.',
  },
  generic: {
...
export function EmptyState({
  ...
  return (
    ...
    >
      ...
      <p className="mx-auto mt-1 max-w-sm text-sm text-gray-500">{description ?? defaults.description}</p>
